...
function obtenerProductos() {
    makeRequest('https://daswpi.herokuapp.com/api/admin/products', 'GET', null, {'x-auth-user': localStorage.tokenUser}, 
    (value) => {
        console.log('Ok');
        console.log(value);
...
function changePage(page)
{
    ...
    for (var i = (page-1) * records_per_page; i < (page * records_per_page); i++) {
        ...
        <div class="media-right align-self-center">
            <div class="row">
                <a href="#" onclick="editProduct('${productos[i].nombre},/$${productos[i].condicion},/$${productos[i].uso},/$${productos[i].precio},/$${productos[i].producto},/$${productos[i].descripcion},/$${productos[i].url},/$${id}')" class="btn btn-primary mt-2"><i class="fa fa-edit edit  "></i></a>
            </div>
            <div class="row">
                <a href="#" onclick="deleteProduct('${productos[i].nombre},/$${productos[i].user_nombre},/$${productos[i].user_apellido},/$${productos[i].precio},/$${productos[i].descripcion},/$${productos[i].url},/$${id}')" class="btn btn-primary mt-2"><i class="fa fa-trash  remove "></i></i></a>
            </div>
        </div>
    </div>`;
